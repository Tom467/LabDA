        ...
        if not exponents:
            ...
            for i in range(len(pi_data)):
                for j in range(i + 1, len(pi_data)):
                    ...
                    # Regular Plot - LaTeX axis labels
                    fig1 = px.scatter(
                        plot_df,
                        x=f"π{i+1}",
                        y=f"π{j+1}",
                    ...
                    # Reciprocal plot - LaTeX axis labels
                    ...
                    if np.any(valid):
                        ...
                        fig2 = px.scatter(
                            ...
                            x=f"1/π{i+1}",
                            y=f"1/π{j+1}",
                            title=f"$\\frac{{1}}{{\\pi_{{{j+1}}}}}$ vs $\\frac{{1}}{{\\pi_{{{i+1}}}}}$",
                            labels={
                                f"1/π{i+1}": f"$\\frac{{1}}{{\\pi_{{{i+1}}}}}$",
                                f"1/π{j+1}": f"$\\frac{{1}}{{\\pi_{{{j+1}}}}}$"
                            },
                            width=450,
                            height=450
                        )
